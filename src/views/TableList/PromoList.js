...
export default function PromoList() {
  ...
  const [listPromo, setListPromo] = React.useState([]);

  const fetchData = () => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/articles/type/promo`)
      .then(response => {
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            <h3 className={classes.cardTitleWhite}>Promo</h3>
            <Button
              variant="contained"
